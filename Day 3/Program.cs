    ...
    class Program
    {
        ...
        static List<int[]> ParseInput(string inputString)
        {
            ...
            for (int i = 0; i < array.Length; i++)
            {
                if (array[i][0] == 'R')
                {
                    for (int j = 0; j < int.Parse(array[i].Substring(1)); j++)
                    {
