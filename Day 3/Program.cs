...
namespace Day_3
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            for (int i = 0; i < string0a.Length; i++)
            {
                for (int j = 0; j < string1a.Length; j++)
                {
                    ...
                    {
                        int result = new int();
                        result = Math.Abs(string0a[i][0]) + Math.Abs(string0a[i][1]);
                        candidates.Add(result);
                        
                    }
                }

                // if (string1.Contains(string0[i]))
                // {
                //     int result = string0[i][0] + string0[i][1];
                //     candidates.Add(result);
                // }
            }
        ...
        //         if (array[i][0] == 'R')
        //         {
        //             x[i + 1] = x[i] + int.Parse(array[i].Substring(1));
        //             y[i + 1] = y[i];
        //         }
        //         if (array[i][0] == 'L')
        //         {
        ...
        //         {
        //             x[i + 1] = x[i];
        //             y[i + 1] = y[i] + int.Parse(array[i].Substring(1));
        //         }
        //         if (array[i][0] == 'D')
        //         {
        //             x[i + 1] = x[i];
        ...
        //         }
        //     }
        //     int[,] total = new int[array.Length + 1,2];
